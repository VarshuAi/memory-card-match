...
author: VarshuAi
description: >
  name: memory-card-match version: 1.0 type: Repository author: VarshuAi description: >   name: memory-card-match version: 1.0 type: Repository author: VarshuAi description: >   name: memory-card-match version: 1.0 type: Repository author: VarshuAi description: >   name: memory-card-match version: 1.0 type: Repository author: VarshuAi description: >   name: memory-card-match version: 1.0 type: Repository author: VarshuAi description: >   name: memory-card-match version: 1.0 type: Repository author: VarshuAi description: >   Fluid matching card game with emoji sets and moves counter. primary_tech: CSS primary_tech: CSS primary_tech: CSS primary_tech: CSS primary_tech: CSS primary_tech: CSS
primary_tech: CSS
```
...
git clone https://github.com/VarshuAi/memory-card-match.git
...
<a href="https://github.com/VarshuAi/memory-card-match"><img src="https://img.shields.io/badge/memory-card-match-Repo-2E7D32?style=for-the-badge&logo=github&logoColor=black" alt="Repository"/></a>
