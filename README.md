...
<div align="center">
<br>
[![Activity Graph](https://github-readme-activity-graph.vercel.app/graph?username=VarshuAi&repo=memory-card-match&theme=react-dark&bg_color=000000&color=00FF88&line=00FF88&point=00CC66)](https://github.com/VarshuAi/memory-card-match)
<br>
</div>
...
1. **Clone the repository:**
   ```bash
   git clone https://github.com/VARSHAN69/memory-card-match.git
   cd memory-card-match
   ```
...
[![Repo](https://img.shields.io/badge/memory-card-match-Repo-00CC66?style=for-the-badge&logo=github&logoColor=black)](https://github.com/VarshuAi/memory-card-match)
