...
<img src="https://capsule-render.vercel.app/api?type=cylinder&color=000000,005f00,000000&height=180&section=header&text=memory-card-match&fontSize=48&fontColor=ffffff&fontAlignY=38&animation=fadeIn" width="100%"/>
...
author: VarshuAi
description: >
  name: memory-card-match version: 1.0 type: Repository author: VarshuAi description: >   name: memory-card-match version: 1.0 type: Repository author: VarshuAi description: >   name: memory-card-match version: 1.0 type: Repository author: VarshuAi description: >   name: memory-card-match version: 1.0 type: Repository author: VarshuAi description: >   name: memory-card-match version: 1.0 type: Repository author: VarshuAi description: >   Fluid matching card game with emoji sets and moves counter. primary_tech: CSS primary_tech: CSS primary_tech: CSS primary_tech: CSS primary_tech: CSS
primary_tech: CSS
```
...
<a href="https://github.com/VarshuAi/memory-card-match"><img src="https://img.shields.io/badge/memory-card-match-Repo-00FF00?style=for-the-badge&logo=github&logoColor=black" alt="Repository"/></a>
